...
<body>
  ...
  <div class="header__container">
    ...
    if ( ! empty( $logo_image ) ) :?>
      <a href="<?php echo esc_url( home_url( ) ); ?>" class="header__logo"><img src="<?php echo esc_url( $logo_image[0] ); ?>" alt="<?php bloginfo( 'name' ); ?>"></a>
    <?php endif; ?>
      <?php
      ...
      if (get_field('phone', 'option')){
        ?>
        <a href="tel:<?php the_field('phone', 'option')?>" class="header__link header__link_phone">
          <span class="header__link-icon">
            <svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
